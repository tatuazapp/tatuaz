      ...
      <Accordion allowToggle index={selectedQuestion - 1}>
        <AccordionItem border={0}>
          ...
          >
            ...
            >
              <MobileQuestionTitleWrapper>
                <MobileQuestionNumber isHovered={isHoveredFirstQuestionHovered}>
                  01.
                </MobileQuestionNumber>
                <MobileQuestionTitle isHovered={isHoveredFirstQuestionHovered}>
          ...
          >
            ...
            >
              <MobileQuestionTitleWrapper>
                ...
                <MobileQuestionTitle isHovered={isHoveredSecondQuestionHovered}>
        ...
        <AccordionItem border={0}>
          ...
          >
            ...
            >
              <MobileQuestionTitleWrapper>
                <MobileQuestionNumber isHovered={isHoveredThirdQuestionHovered}>
                  03.
                </MobileQuestionNumber>
                <MobileQuestionTitle isHovered={isHoveredThirdQuestionHovered}>
