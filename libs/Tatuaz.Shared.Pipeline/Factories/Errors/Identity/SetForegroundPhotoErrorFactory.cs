...
public class SetForegroundPhotoErrorFactory
{
    public static TatuazError InvalidFileFormatError(string? message = null)
    {
        return message is null
            ? new TatuazError(SetForegroundPhotoErrorCodes.InvalidFileFormat, "Invalid file format. Acceptable formats: jpg, jpeg, png, webp.")
