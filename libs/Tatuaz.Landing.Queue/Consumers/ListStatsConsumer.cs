...
public class ListStatsConsumer : TatuazConsumerBase<ListStatsOrder, IEnumerable<SummaryStatDto>>
{
    ...
    protected override async Task<TatuazResult<IEnumerable<SummaryStatDto>>> ConsumeMessage(ListStatsOrder message)
    {
        var stats = new List<SummaryStatDto>
        {
            ...
            new("Największy wędkarz na świecie", "1,90 m",
            ...
            new("Minuty walki z rybami", "1 000 000",
                "https://www.rtw.org.pl/images/gallery/photos/bytyn2_ccfec497.jpg"),
            new("Rocznica pierwszego złowionego rekina", DateTime.Now.ToShortDateString(),
            ...
            new("Nowe rybne pary młode", "30",
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvWekaZcXBAG5cEeFbaS1UFDVJNRHJVopxCg&usqp=CAU"),
            new("Rekordowe akwaria", "1", "https://demotywatory.pl/uploads/201811/1542733227_huzjlt_fb_plus.jpg")
        };
