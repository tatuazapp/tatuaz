...
{
    private readonly Instant[] _dateTimes;
    ...
    public PrimitiveValuesGenerator()
    {
        ...
        for (var i = 0; i < 10; i++)
        {
            ...
            _dateTimes[i] = Instant.FromUtc(2020, 1, 1, 0, 0).Plus(Duration.FromMilliseconds(Random.Shared.Next()));
