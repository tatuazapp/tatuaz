...
resource "kubernetes_secret" "k8s_history" {
  ...
  data = {
    ...
    ConnectionStrings__TatuazHistDb = "Server=${kubernetes_service.k8s_postgres.spec[0].cluster_ip};Port=5432;Database=TatuazHistDb;User Id=${var.k8s_postgres.admin_login};Password=${var.k8s_postgres.admin_password};"
  }
}
